...
export default function Home() {
  return (
    <>
      <section className="bg-dotted-pattern h-[70vh] bg-primary-50 bg-contain py-5 md:py-10">
        <div className="wrapper md:grid-cols-2 grid grid-cols-1 2xl:gap-0">
          <div className="flex flex-col justify-center gap-8">
            ...
            <button
              className="rounded-md bg-black text-white w-fit px-3 py-2"
              href="#select"
            >
              <Link href="#select">Choose your category</Link>
            </button>
          </div>
      ...
      <section id="select" className="md:mt-2 mt-[200px]">
        ...
        <div className="wrapper">
          <button className="rounded-md bg-black text-white w-fit px-3 py-2">
            <Link target="_blank" href="https://applydlnew.dotm.gov.np/login">
